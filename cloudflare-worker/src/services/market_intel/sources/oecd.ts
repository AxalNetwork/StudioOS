/**
   * Task #14 (AA-1) — OECD productivity + R&D connector.
   *
   * Cadence: weekly. Dimensions: capital, research. Weight: 0.55.
   *
   ...
   * dev. Set MI_FLAG_OECD=live in production env to engage fetchLive.
   */
