/**
   * Task #14 (AA-1) — World Bank macro indicators connector.
   *
   * Cadence: weekly. Dimensions: capital. Weight: 0.55.
   *
   ...
   * dev. Set MI_FLAG_WORLD_BANK=live in production env to engage fetchLive.
   */
  ...
  registerSource({
    ...
    fetchLive: async (_env, { sectors }) => {
      // TODO: wire real World Bank macro indicators client. Falls back to stub semantics
