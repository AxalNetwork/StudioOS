...
export const DECK_METHODS: DeckMethodSpec[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { ...gtmSlide, id: 'expansion', title: 'Expansion' },
      competitionSlide, productDeepSlide, roadmapSlide,
      teamSlide, captableSlide, financialsSlide,
      { ...financialsSlide, id: 'capital_plan', title: 'Capital plan' },
      { ...financialsSlide, id: 'risks', title: 'Risks & mitigations' },
      askSlide,
      { ...marketSlide, id: 'metrics_appendix', title: 'Metrics appendix', appendix: true },
      { ...financialsSlide, id: 'financials_appendix', title: 'Financials appendix', appendix: true },
      { ...captableSlide, id: 'captable_appendix', title: 'Cap table appendix', appendix: true },
    ],
  },
  {
  ...
  },
  {
    ...
    slides: [
      ...
      { ...marketSlide, id: 'a_market', title: 'Appendix: market sizing', appendix: true },
      { ...tractionSlide, id: 'a_cohorts', title: 'Appendix: cohorts', appendix: true },
      ...
      { ...productDeepSlide, id: 'a_product', title: 'Appendix: product', appendix: true },
      { ...productDeepSlide, id: 'a_security', title: 'Appendix: security', appendix: true },
      { ...gtmSlide, id: 'a_gtm', title: 'Appendix: GTM detail', appendix: true },
      { ...competitionSlide, id: 'a_comp', title: 'Appendix: competition deep-dive', appendix: true },
      { ...roadmapSlide, id: 'a_roadmap', title: 'Appendix: roadmap', appendix: true },
      { ...teamSlide, id: 'a_team', title: 'Appendix: team', appendix: true },
    ],
  },
  {
