  ...
  // canonical SAMPLE_DATA shape via mergeShape().
  {
    ...
    slides: [
      { id: 'cover', title: 'Cover', fields: [
        ...
        // Deck-wide envelope — every meta value rides as a real text input.
        f.para('meta_project_name', 'Project name', []),
        f.para('meta_sector', 'Sector', []),
        f.para('meta_founder_name', 'Founder name', []),
        f.para('meta_contact_email', 'Contact email', []),
        f.para('meta_presented_on', 'Presented on', []),
        f.para('meta_week', 'Lab week', []),
        f.para('meta_days_remaining', 'Days remaining', []),
        f.para('meta_lab_active', 'Lab active (true / false)', []),
        f.para('meta_is_sample', 'Sample deck (true / false)', []),
      ] },
      ...
      { id: 'validation', title: 'Validation', fields: [
        ...
        f.para('validation_quote1_name', 'Quote 1 — name', []),
        f.para('validation_quote1_role', 'Quote 1 — role', []),
        f.para('validation_quote1_takeaway', 'Quote 1 — takeaway', []),
        f.para('validation_quote2_name', 'Quote 2 — name', []),
        f.para('validation_quote2_role', 'Quote 2 — role', []),
        f.para('validation_quote2_takeaway', 'Quote 2 — takeaway', []),
        f.para('validation_quote3_name', 'Quote 3 — name', []),
        f.para('validation_quote3_role', 'Quote 3 — role', []),
        f.para('validation_quote3_takeaway', 'Quote 3 — takeaway', []),
      ] },
