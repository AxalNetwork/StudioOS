...
export const REGISTRY: ProviderDescriptor[] = [
  ...
  },
  {
    ...
    description: 'Mirror your Carta cap table into the Capital module and sync 409A valuations.',
    status: 'coming_soon',
    tier: 'studio',
    auth_type: 'api_key',
    capabilities: ['Cap-table sync', '409A valuations', 'Stakeholder import'],
  ...
  },
  {
    ...
    description: 'Auto-enrich projects with Crunchbase company data — funding, headcount, sector tags.',
    status: 'coming_soon',
    tier: 'growth',
    auth_type: 'api_key',
