...
- **A real person confirms your role.** The Axal team reviews what you shared, sends you a membership agreement to sign, and only then unlocks the workspace that matches you — founder, investor, partner, or advisor.
...
## A clearer "Team & Network" slide in the Spin-Out deck

The team slide in the Spin-Out demo-day deck now fits neatly no matter how big your team is. It shows real profile photos (with tidy initials when a photo isn't available), gives everyone a short role label, and supports multiple founders or co-founders with compact cards. A single-founder deck still looks just like before, and the network graph on the right is unchanged.
