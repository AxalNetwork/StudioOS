...
export default function InactivityWarningModal({ open, secondsLeft, onStay, onLogout }) {
  ...
  return (
    ...
    >
      <div className="bg-white border border-gray-200 rounded-xl shadow-2xl max-w-md w-[90%] p-6">
        <div className="flex items-start gap-3 mb-4">
          <div className="bg-amber-100 text-amber-600 rounded-lg p-2 flex-shrink-0">
            <ShieldAlert size={20} />
          </div>
          <div>
            <h2 id="inactivity-title" className="text-base font-semibold text-gray-900">
