              ...
              <div className="flex items-start justify-between gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    disabled={actionId === `${d.source}:${d.id}`}
                    className="px-2.5 py-1.5 text-xs bg-white border border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 rounded-lg flex items-center gap-1 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300"
                  >
