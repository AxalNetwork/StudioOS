  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col pt-16">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6 dark:text-gray-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">1. LOSS OF PRINCIPAL</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">2. ILLIQUIDITY AND LACK OF RESALE</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">3. DILUTION</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">4. LACK OF OPERATING HISTORY</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">5. VALUATION SUBJECTIVITY</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">7. MINORITY RIGHTS & CONTROL</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">8. TAX CONSEQUENCES</h2>
