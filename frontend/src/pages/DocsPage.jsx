      ...
      <div ref={contentRef} className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto px-6 py-8">
          ...
          <UL>
            ...
            <LI><Strong>Google Calendar</Strong> — connect from <Strong>Calendar</Strong> to mirror IC meetings and founder check-ins to your personal calendar (per-user OAuth, refresh-token sync). <Strong>Outlook / Microsoft 365</Strong> support is coming soon.</LI>
