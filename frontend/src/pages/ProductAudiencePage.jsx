...
function Benefit({ icon, title, body, accent }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow dark:bg-gray-900 dark:border-gray-800">
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${accent.chip}`}>
        <Glyph size={18} />
      </div>
      <h3 className="text-base font-semibold text-gray-900 mb-1.5 dark:text-gray-100">{title}</h3>
    ...
    <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            ...
            className="text-4xl md:text-6xl font-bold leading-tight tracking-tight text-gray-900 mb-5 dark:text-gray-100"
          >
            {hero.headlinePre}
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 items-center justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 border border-gray-300 hover:border-gray-400 transition-colors px-7 py-3.5 rounded-xl text-sm font-medium text-gray-800 dark:border-gray-700 dark:text-gray-200"
            >
              {cfg.secondaryCta.label}
            </Link>
          </div>
          <p className="mt-6 text-sm text-gray-500 max-w-2xl mx-auto">
            <span className="font-semibold text-gray-700 dark:text-gray-300">Who it's for:</span> {cfg.forWho}
          </p>
        </div>
      </section>
      ...
      <section className="pb-4 px-6">
        <div className={`max-w-3xl mx-auto rounded-2xl border p-6 md:p-8 text-center ${accent.sectionTint}`}>
          ...
          <p className="text-base md:text-lg text-gray-800 leading-relaxed dark:text-gray-200">{cfg.problem}</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3 dark:text-gray-100">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 dark:bg-gray-900 dark:border-gray-800">
              ...
              <ul className="space-y-3">
                {cfg.liveFeatures.map((f) => (
                  <li key={f} className="flex items-start gap-2 text-sm text-gray-700 leading-relaxed dark:text-gray-300">
      ...
      <section id="pricing" className="py-20 px-6 scroll-mt-24">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3 dark:text-gray-100">Pricing.</h2>
            <p className="text-gray-600 max-w-xl mx-auto">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-10 text-center dark:text-gray-100">FAQ.</h2>
          <div className="space-y-3">
            {cfg.faq.map((f, i) => (
              <details
                key={i}
                className="group bg-white border border-gray-200 rounded-xl p-5 open:border-gray-300 dark:bg-gray-900 dark:border-gray-800"
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed mt-3 dark:text-gray-300">{f.a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className={`max-w-3xl mx-auto rounded-3xl border-2 p-8 md:p-12 text-center ${accent.sectionTint}`}>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 dark:text-gray-100">{cfg.closing.headline}</h2>
          <p className="text-base text-gray-700 mb-8 dark:text-gray-300">{cfg.closing.sub}</p>
