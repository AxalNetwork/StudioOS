...
export const HQ_ONLY_ACTIONS = [
  ...
  },
  {
    ...
    hq: true,
    gate: 'Demote: your authenticator, a fresh step-up and a typed reason. Deactivate: the Super Admin alone, with the same three — your authenticator, a fresh step-up and a typed reason of at least 10 characters — and re-opening the account asks for them again. An admin whose account lives on a branch database is unbound instead, with the same three: Unbind on their hit in the Team table’s branch search demotes and deactivates them on that branch, and terminating the licence unbinds every administrator the branch holds.',
    where: 'Demote on the licence’s Administrators tab; deactivate with Disable on the directory below; Unbind on a branch hit in the Team table.',
    link: 'licences',
