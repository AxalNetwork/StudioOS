...
function RaiseSections({ loading, project, data, errors, query, state }) {
  ...
  return <div className="raise-sections">
    ...
    <section className="raise-card exits" id="raise-liquidity"><Head icon={Landmark} title="Liquidity & exits" meta="Not recorded" /><p>No project-linked exit model or secondary is recorded. This desk does not fabricate a waterfall.</p><DeskLink testid="link-open-liquidity" to={`/raise/liquidity${query}`} state={state}>Open liquidity</DeskLink></section>
  </div>;
}
