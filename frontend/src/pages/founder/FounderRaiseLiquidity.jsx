...
export default function FounderRaiseLiquidity() {
  ...
  return <main className="fr-capital fr-liquidity" data-testid="founder-raise-liquidity"><div className="fr-capital-shell"><section className="fr-capital-main">
    ...
    <ZoneActions className="mt-3" items={founderZoneActions('raise/liquidity', { query, view: { scope: project?.name, header: ['Holder', 'Type', 'Ownership %', 'Preference', 'Payout', 'Source'], rows: waterfall?.rows || [], cells: (r) => [r.holder, r.type, r.pct, r.preference, r.payout, r.source] } })} /></header>
