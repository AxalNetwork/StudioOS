...
export default function ActivityPage() {
  ...
  const actionColors = {
    ai_advisory_query: 'text-violet-400 bg-violet-500/10',
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-400 mb-6">Audit trail of all system events</p>

      {summary && (
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
            <div className="text-[10px] text-gray-500 uppercase">Total Events</div>
            <div className="text-2xl font-bold text-white mt-1">{summary.total_events}</div>
          </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-800 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-white">Event Stream</span>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${
                        actionColors[log.action] || 'text-gray-400 bg-gray-800'
