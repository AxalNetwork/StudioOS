/**
 * Task #11 (AC-2) — Mentor question bank.
 *
 * Column names mirror the live D1 `mentors` schema (display_name,
...
export const MENTOR_BANK = [
  // --- Identity --------------------------------------------------------
  {
    id: 'mentor.profile.display_name',
    label: 'What name should we display on your mentor profile?',
    type: 'short',
    explainer: 'Shown to founders in the mentor directory and on office-hours invites.',
    doc_anchor: 'portals/mentor',
    page_target: '/mentors/me',
  ...
  },
  {
    ...
    type: 'long',
    explainer: 'Headline + bio is what the mentor matcher reads when ranking suggestions.',
    doc_anchor: 'portals/mentor',
    page_target: '/mentors/me',
  ...
  // --- Comp preference -------------------------------------------------
  {
    id: 'mentor.profile.hourly_rate_usd',
    label: 'Your hourly rate in USD (0 if pro-bono).',
    type: 'number',
    explainer: 'Pro-bono mentors are surfaced first to free-tier founders.',
    doc_anchor: 'portals/mentor',
    page_target: '/mentors/me',
  ...
  // --- Calendar --------------------------------------------------------
  {
    id: 'mentor.calendar.weekly_hours',
  ...
  // --- LinkedIn --------------------------------------------------------
  {
    id: 'mentor.profile.linkedin_url',
    label: 'Share your LinkedIn URL so founders can vet you.',
    type: 'short',
    explainer: 'Public link rendered on your mentor card so founders can vet you before booking.',
    doc_anchor: 'portals/mentor',
    page_target: '/mentors/me',
