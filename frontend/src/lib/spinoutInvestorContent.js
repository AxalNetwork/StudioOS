...
export const STACK = [
  ...
  { t: 'Product & iteration', week: 'Week 2', body: 'MVP prioritization by added value and effort, OKR locking, and an execution loop that pulls the highest-value scope into the active cycle.', tools: ['Roadmap', 'MVP Priorities'] },
