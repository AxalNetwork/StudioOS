...
export const TEMPLATES: Record<string, TemplateMeta> = {
  ...
  partnership_bd:     { key: 'partnership_bd',     label: 'Partnership / BD',              description: '12 slides · mutual value',                         slide_count: 12, required_tier: 'growth', category: 'commercial',  Component: Deck_partnership_bd },
  ...
  investor_appendix:  { key: 'investor_appendix',  label: 'Investor + Appendix',           description: '13 slides + appendix · with data room',            slide_count: 23, required_tier: 'studio', category: 'fundraising', Component: Deck_investor_appendix },
