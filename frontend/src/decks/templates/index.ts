...
export const TEMPLATES: Record<string, TemplateMeta> = {
  ...
  axal_spinout_demoday: { key: 'axal_spinout_demoday', label: 'Axal 30-day Spin-Out Lab — Demo Day', description: '14 slides · 4 variants (editorial / product-first / data-dense / manifesto) · binds to Lab data', slide_count: 14, required_tier: 'growth', category: 'fundraising', Component: Deck_axal_spinout_demoday },
};
