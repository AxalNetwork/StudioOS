...
export const TEMPLATES: Record<string, TemplateMeta> = {
  ...
  axal_spinout_demoday: { key: 'axal_spinout_demoday', label: 'Axal VC Spin-Out', description: '9 slides · editorial · binds to Lab data', slide_count: 9, required_tier: 'growth', category: 'event', Component: Deck_axal_spinout_demoday, brandTheme: 'accent_only' },
  // full — full palette override (bg, ink, accent, fonts)
